...
def test_is_coherent():
    ...
    assert is_coherent == False, "Should not be coherent with custom high threshold"
...
def test_evaluate():
    ...
    assert result['coherent'] == True, "Should be coherent"
    ...
    assert result['coherent'] == False, "Should not be coherent"
