...
if __name__ == "__main__":
    ...
    visualizar_pozo(pozo_std, niveles=4, 
                   filename="pozo_cuantico_estandar.png")
    visualizar_espectro_energetico(pozo_std, niveles=10,
                                   filename="espectro_energia_estandar.png")
    visualizar_pozo(pozo_universal, niveles=4,
                   filename="resonador_basal_universal.png")
    visualizar_espectro_energetico(pozo_universal, niveles=10,
                                   filename="espectro_energia_universal.png")
